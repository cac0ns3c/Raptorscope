...
Common Schema, runs 140 paired Sigma detections, and serves it through a FastAPI
...
`140 detections` · `555 tests` · `dual detection engines, 0-divergence parity` ·
...
- **140 paired detections, agent-reviewed** — every rule ships hit + benign
...
flowchart LR
  ...
  RULES["140 Sigma detections<br/>paired hit + benign"] --> DET
...
| `macos.process`    | `MacOS.Sys.Pslist` (+ signature-enrichment VQL)          | what ran              | 81 |
